...
export function DashboardPreview() {
  return (
    <div className="relative">
      <div className="pointer-events-none absolute -inset-x-10 -bottom-10 top-10 -z-10 rounded-[40px] bg-accent/20 blur-[100px]" />

      <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#0f0f10] shadow-2xl shadow-black/60">
        <div className="flex">
          <Sidebar />
